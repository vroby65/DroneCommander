...
Blockly.Msg["BKY_DRONE_TAKE_PHOTO"] = "tirar uma foto";
Blockly.Msg["BKY_DRONE_TAKE_PHOTO_TOOLTIP"] = "Transfere uma imagem PNG da câmara do drone";
Blockly.Msg["BKY_DRONE_START_RECORDING"] = "iniciar gravação";
Blockly.Msg["BKY_DRONE_START_RECORDING_TOOLTIP"] = "Inicia a gravação de vídeo da câmara do drone";
Blockly.Msg["BKY_DRONE_SAVE_RECORDING"] = "guardar gravação";
Blockly.Msg["BKY_DRONE_SAVE_RECORDING_TOOLTIP"] = "Termina a gravação e transfere o vídeo da câmara do drone";
...
Blockly.Msg["BKY_DRONE_MOVE_BY_TOOLTIP"] = "Move relativamente à direção atual: X direita/esquerda, Y cima/baixo, Z frente/trás";

Blockly.Msg["BKY_DRONE_CURVE_ABS"] = "curva abs x %1 y %2 z %3 xd %4 yd %5 zd %6";
Blockly.Msg["BKY_DRONE_CURVE_ABS_TOOLTIP"] = "Faz o drone voar em uma curva que passa pela posição atual, por um ponto intermediário absoluto e por um destino absoluto";

Blockly.Msg["BKY_DRONE_CURVE"] = "curva x %1 y %2 z %3 xd %4 yd %5 zd %6";
Blockly.Msg["BKY_DRONE_CURVE_TOOLTIP"] = "Faz o drone voar numa curva com pontos relativos à direção atual (Z frente/trás, X direita/esquerda)";

Blockly.Msg["BKY_DRONE_RETURN_TO_BASE"] = "voltar à base";
Blockly.Msg["BKY_DRONE_RETURN_TO_BASE_TOOLTIP"] = "Leva o drone de volta à base usando a velocidade atual";
...
Blockly.Msg["BKY_DRONE_SPEED"] = "velocidade %1";
Blockly.Msg["BKY_DRONE_SPEED_TOOLTIP"] = "define a velocidade do drone (de 0 a 10)";
...
Blockly.Msg["BKY_SENSOR_SPEED"] = "velocidade";
Blockly.Msg["BKY_SENSOR_SPEED_TOOLTIP"] = "Retorna a velocidade do drone";


// Flow
Blockly.Msg["BKY_FLOW_START_TOOLTIP"] = "início do programa";
Blockly.Msg["BKY_FLOW_END_TOOLTIP"] = "fim do programa";

Blockly.Msg["BKY_FLOW_START"] = "Início";
Blockly.Msg["BKY_FLOW_END"] = "Fim";
