...
Blockly.Msg["BKY_DRONE_TAKEOFF"] = "이륙";
Blockly.Msg["BKY_DRONE_TAKEOFF_TOOLTIP"] = "드론을 이륙시킵니다";
Blockly.Msg["BKY_DRONE_LAND"] = "착륙";
Blockly.Msg["BKY_DRONE_LAND_TOOLTIP"] = "드론을 착륙시킵니다";
Blockly.Msg["BKY_DRONE_TAKE_PHOTO"] = "사진 촬영";
Blockly.Msg["BKY_DRONE_TAKE_PHOTO_TOOLTIP"] = "드론 카메라의 PNG 이미지를 다운로드합니다";
Blockly.Msg["BKY_DRONE_START_RECORDING"] = "녹화 시작";
Blockly.Msg["BKY_DRONE_START_RECORDING_TOOLTIP"] = "드론 카메라 영상 녹화를 시작합니다";
Blockly.Msg["BKY_DRONE_SAVE_RECORDING"] = "녹화 저장";
Blockly.Msg["BKY_DRONE_SAVE_RECORDING_TOOLTIP"] = "녹화를 중지하고 드론 카메라 영상을 다운로드합니다";
Blockly.Msg["BKY_DRONE_SET_ALTITUDE"] = "고도 설정 %1";
Blockly.Msg["BKY_DRONE_SET_ALTITUDE_TOOLTIP"] = "드론의 고도를 설정합니다";
Blockly.Msg["BKY_DRONE_CHANGE_ALTITUDE"] = "고도 변경 %1";
Blockly.Msg["BKY_DRONE_CHANGE_ALTITUDE_TOOLTIP"] = "드론의 고도를 상대적으로 변경합니다";
Blockly.Msg["BKY_DRONE_SET_ANGLE"] = "각도 설정 %1";
Blockly.Msg["BKY_DRONE_SET_ANGLE_TOOLTIP"] = "드론의 방향 각도를 설정합니다";
Blockly.Msg["BKY_DRONE_CHANGE_ANGLE"] = "각도 변경 %1";
Blockly.Msg["BKY_DRONE_CHANGE_ANGLE_TOOLTIP"] = "드론의 방향 각도를 상대적으로 변경합니다";
Blockly.Msg["BKY_DRONE_SLIDE"] = "옆으로 이동 %1";
Blockly.Msg["BKY_DRONE_SLIDE_TOOLTIP"] = "드론을 옆으로 이동시킵니다";
Blockly.Msg["BKY_DRONE_WALK"] = "전진 %1";
Blockly.Msg["BKY_DRONE_WALK_TOOLTIP"] = "드론을 앞으로 이동시킵니다";
Blockly.Msg["BKY_DRONE_WALK_CLIMBING"] = "전진 %1 상승 %2";
Blockly.Msg["BKY_DRONE_WALK_CLIMBING_TOOLTIP"] = "드론이 앞으로 이동하면서 고도를 변경합니다";
Blockly.Msg["BKY_DRONE_GO_TO"] = "이동 위치 x %1 y %2 z %3";
Blockly.Msg["BKY_DRONE_GO_TO_TOOLTIP"] = "현재 속도로 절대 위치로 이동합니다";
Blockly.Msg["BKY_DRONE_MOVE_BY"] = "상대 이동 x %1 y %2 z %3";
Blockly.Msg["BKY_DRONE_MOVE_BY_TOOLTIP"] = "현재 방향을 기준으로 이동합니다: X 오른쪽/왼쪽, Y 위/아래, Z 앞/뒤";
Blockly.Msg["BKY_DRONE_CURVE_ABS"] = "절대 곡선 x %1 y %2 z %3 xd %4 yd %5 zd %6";
Blockly.Msg["BKY_DRONE_CURVE_ABS_TOOLTIP"] = "현재 위치, 절대 중간점, 절대 목적지를 지나는 곡선으로 비행합니다";
Blockly.Msg["BKY_DRONE_CURVE"] = "상대 곡선 x %1 y %2 z %3 xd %4 yd %5 zd %6";
Blockly.Msg["BKY_DRONE_CURVE_TOOLTIP"] = "드론의 현재 방향을 기준으로 한 점들을 따라 곡선 비행합니다(Z 앞/뒤, X 오른쪽/왼쪽)";
Blockly.Msg["BKY_DRONE_RETURN_TO_BASE"] = "기지로 복귀";
Blockly.Msg["BKY_DRONE_RETURN_TO_BASE_TOOLTIP"] = "현재 속도로 기지로 돌아갑니다";
Blockly.Msg["BKY_DRONE_WAIT"] = "대기 %1";
Blockly.Msg["BKY_DRONE_WAIT_TOOLTIP"] = "드론을 대기시킵니다";
Blockly.Msg["BKY_DRONE_SMOKE"] = "연기 %1";
Blockly.Msg["BKY_DRONE_SMOKE_TOOLTIP"] = "드론의 연기를 켜거나 끕니다";
Blockly.Msg["BKY_DRONE_SPEED"] = "속도 %1";
Blockly.Msg["BKY_DRONE_SPEED_TOOLTIP"] = "드론 속도를 설정합니다(0~10)";
Blockly.Msg["BKY_SENSOR_KEYPRESSED"] = "키 %1 눌림";
Blockly.Msg["BKY_SENSOR_KEYPRESSED_TOOLTIP"] = "키가 눌렸으면 참을 반환합니다";
Blockly.Msg["ARROW_UP"] = "위쪽 화살표";
Blockly.Msg["ARROW_DOWN"] = "아래쪽 화살표";
Blockly.Msg["ARROW_LEFT"] = "왼쪽 화살표";
Blockly.Msg["ARROW_RIGHT"] = "오른쪽 화살표";
Blockly.Msg["SPACE"] = "스페이스";
Blockly.Msg["RETURN"] = "엔터";
Blockly.Msg["BKY_SENSOR_X"] = "X";
Blockly.Msg["BKY_SENSOR_X_TOOLTIP"] = "드론의 X 좌표를 반환합니다";
Blockly.Msg["BKY_SENSOR_Z"] = "Z";
Blockly.Msg["BKY_SENSOR_Z_TOOLTIP"] = "드론의 Z 좌표를 반환합니다";
Blockly.Msg["BKY_SENSOR_ALTITUDE"] = "고도";
Blockly.Msg["BKY_SENSOR_ALTITUDE_TOOLTIP"] = "드론의 현재 고도를 반환합니다";
Blockly.Msg["BKY_SENSOR_DIRECTION"] = "방향";
Blockly.Msg["BKY_SENSOR_DIRECTION_TOOLTIP"] = "드론의 현재 방향을 반환합니다";
Blockly.Msg["BKY_SENSOR_SPEED"] = "속도";
Blockly.Msg["BKY_SENSOR_SPEED_TOOLTIP"] = "드론의 현재 속도를 반환합니다";
Blockly.Msg["BKY_FLOW_START_TOOLTIP"] = "프로그램 시작";
Blockly.Msg["BKY_FLOW_END_TOOLTIP"] = "프로그램 종료";
Blockly.Msg["BKY_FLOW_START"] = "시작";
Blockly.Msg["BKY_FLOW_END"] = "끝";
Blockly.Msg["BKY_NEW"] = "새로 만들기";
Blockly.Msg["BKY_LOAD"] = "불러오기";
Blockly.Msg["BKY_SAVE"] = "저장";
Blockly.Msg["BKY_HELP"] = "도움말";
Blockly.Msg["BKY_SCENARIO"] = "시나리오";
Blockly.Msg["BKY_FILE_NAME"] = "이름 없음";
Blockly.Msg["BKY_SAVE_PROMPT"] = "파일 이름:";
Blockly.Msg["BKY_GRAPHICS"] = "그래픽";
Blockly.Msg["BKY_GRAPHICS_PERFORMANCE"] = "성능";
Blockly.Msg["BKY_GRAPHICS_BALANCED"] = "균형";
Blockly.Msg["BKY_GRAPHICS_QUALITY"] = "고품질";
Blockly.Msg["BKY_STATUS_X"] = "X:";
Blockly.Msg["BKY_STATUS_Z"] = "Z:";
Blockly.Msg["BKY_STATUS_ALTITUDE"] = "고도:";
Blockly.Msg["BKY_STATUS_DIRECTION"] = "방향:";
Blockly.Msg["BKY_STATUS_FLIGHT"] = "상태:";
Blockly.Msg["BKY_STATUS_VARIABLES"] = "변수:";
Blockly.Msg["BKY_FLIGHT_IN_FLIGHT"] = "비행 중";
Blockly.Msg["BKY_FLIGHT_ON_GROUND"] = "지상";
Blockly.Msg["BKY_CAMERA_PREVIEW"] = "카메라 미리보기";
Blockly.Msg["BKY_DARK_THEME"] = "어두운 테마";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY"] = "사진/동영상 폴더:";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_SELECT"] = "선택...";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_RESET"] = "초기화";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_DEFAULT"] = "브라우저 기본 다운로드";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_UNSUPPORTED"] = "브라우저 기본 다운로드(폴더 선택 미지원)";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_PERMISSION_NEEDED"] = "권한 필요";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_PRIVACY"] = "개인정보 보호를 위해 브라우저에는 선택한 폴더 이름만 표시됩니다.";
Blockly.Msg["BKY_CATEGORY_LOGIC"] = "논리";
Blockly.Msg["BKY_CATEGORY_LOOPS"] = "반복";
Blockly.Msg["BKY_CATEGORY_MATH"] = "수학";
Blockly.Msg["BKY_CATEGORY_TEXT"] = "텍스트";
Blockly.Msg["BKY_CATEGORY_LISTS"] = "목록";
Blockly.Msg["BKY_CATEGORY_VARIABLES"] = "변수";
Blockly.Msg["BKY_CATEGORY_FUNCTIONS"] = "함수";
Blockly.Msg["BKY_CATEGORY_SENSORS"] = "센서";
Blockly.Msg["BKY_CATEGORY_DRONE"] = "드론";
Blockly.Msg["BKY_CATEGORY_FLOW"] = "흐름";
