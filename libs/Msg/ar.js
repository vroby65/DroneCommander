...
// Drone Commander messages
Blockly.Msg["BKY_DRONE_TAKEOFF"] = "إقلاع";
Blockly.Msg["BKY_DRONE_TAKEOFF_TOOLTIP"] = "يجعل الطائرة المسيّرة تقلع";
Blockly.Msg["BKY_DRONE_LAND"] = "هبوط";
Blockly.Msg["BKY_DRONE_LAND_TOOLTIP"] = "يجعل الطائرة المسيّرة تهبط";
Blockly.Msg["BKY_DRONE_TAKE_PHOTO"] = "التقط صورة";
Blockly.Msg["BKY_DRONE_TAKE_PHOTO_TOOLTIP"] = "ينزّل صورة PNG من كاميرا الطائرة المسيّرة";
Blockly.Msg["BKY_DRONE_START_RECORDING"] = "بدء التسجيل";
Blockly.Msg["BKY_DRONE_START_RECORDING_TOOLTIP"] = "يبدأ تسجيل الفيديو من كاميرا الطائرة المسيّرة";
Blockly.Msg["BKY_DRONE_SAVE_RECORDING"] = "حفظ التسجيل";
Blockly.Msg["BKY_DRONE_SAVE_RECORDING_TOOLTIP"] = "يوقف التسجيل وينزّل فيديو كاميرا الطائرة المسيّرة";
Blockly.Msg["BKY_DRONE_SET_ALTITUDE"] = "اضبط الارتفاع %1";
Blockly.Msg["BKY_DRONE_SET_ALTITUDE_TOOLTIP"] = "يضبط ارتفاع الطائرة المسيّرة";
Blockly.Msg["BKY_DRONE_CHANGE_ALTITUDE"] = "غيّر الارتفاع %1";
Blockly.Msg["BKY_DRONE_CHANGE_ALTITUDE_TOOLTIP"] = "يغيّر ارتفاع الطائرة المسيّرة بقيمة نسبية";
Blockly.Msg["BKY_DRONE_SET_ANGLE"] = "اضبط الزاوية %1";
Blockly.Msg["BKY_DRONE_SET_ANGLE_TOOLTIP"] = "يضبط زاوية اتجاه الطائرة المسيّرة";
Blockly.Msg["BKY_DRONE_CHANGE_ANGLE"] = "غيّر الزاوية %1";
Blockly.Msg["BKY_DRONE_CHANGE_ANGLE_TOOLTIP"] = "يغيّر زاوية اتجاه الطائرة المسيّرة بقيمة نسبية";
Blockly.Msg["BKY_DRONE_SLIDE"] = "تحرّك جانبياً %1";
Blockly.Msg["BKY_DRONE_SLIDE_TOOLTIP"] = "يحرّك الطائرة المسيّرة جانبياً";
Blockly.Msg["BKY_DRONE_WALK"] = "تقدّم %1";
Blockly.Msg["BKY_DRONE_WALK_TOOLTIP"] = "يحرّك الطائرة المسيّرة إلى الأمام";
Blockly.Msg["BKY_DRONE_WALK_CLIMBING"] = "تقدّم %1 واصعد %2";
Blockly.Msg["BKY_DRONE_WALK_CLIMBING_TOOLTIP"] = "يحرّك الطائرة المسيّرة إلى الأمام مع تغيير الارتفاع";
Blockly.Msg["BKY_DRONE_GO_TO"] = "انتقل إلى x %1 y %2 z %3";
Blockly.Msg["BKY_DRONE_GO_TO_TOOLTIP"] = "ينتقل إلى موضع مطلق بالسرعة الحالية";
Blockly.Msg["BKY_DRONE_MOVE_BY"] = "تحرّك نسبياً x %1 y %2 z %3";
Blockly.Msg["BKY_DRONE_MOVE_BY_TOOLTIP"] = "يتحرّك نسبةً إلى الاتجاه الحالي: X يمين/يسار، Y أعلى/أسفل، Z أمام/خلف";
Blockly.Msg["BKY_DRONE_CURVE_ABS"] = "منحنى مطلق x %1 y %2 z %3 xd %4 yd %5 zd %6";
Blockly.Msg["BKY_DRONE_CURVE_ABS_TOOLTIP"] = "يطير في منحنى يمر بالموضع الحالي ونقطة وسطى مطلقة ووجهة مطلقة";
Blockly.Msg["BKY_DRONE_CURVE"] = "منحنى نسبي x %1 y %2 z %3 xd %4 yd %5 zd %6";
Blockly.Msg["BKY_DRONE_CURVE_TOOLTIP"] = "يطير في منحنى بنقاط نسبةً إلى اتجاه الطائرة الحالي (Z أمام/خلف وX يمين/يسار)";
Blockly.Msg["BKY_DRONE_RETURN_TO_BASE"] = "العودة إلى القاعدة";
Blockly.Msg["BKY_DRONE_RETURN_TO_BASE_TOOLTIP"] = "يعيد الطائرة المسيّرة إلى القاعدة بالسرعة الحالية";
Blockly.Msg["BKY_DRONE_WAIT"] = "انتظر %1";
Blockly.Msg["BKY_DRONE_WAIT_TOOLTIP"] = "يجعل الطائرة المسيّرة تنتظر";
Blockly.Msg["BKY_DRONE_SMOKE"] = "دخان %1";
Blockly.Msg["BKY_DRONE_SMOKE_TOOLTIP"] = "يشغّل أو يوقف دخان الطائرة المسيّرة";
Blockly.Msg["BKY_DRONE_SPEED"] = "السرعة %1";
Blockly.Msg["BKY_DRONE_SPEED_TOOLTIP"] = "يضبط سرعة الطائرة المسيّرة من 0 إلى 10";
Blockly.Msg["BKY_SENSOR_KEYPRESSED"] = "المفتاح %1 مضغوط";
Blockly.Msg["BKY_SENSOR_KEYPRESSED_TOOLTIP"] = "يعيد صحيحاً إذا كان المفتاح مضغوطاً";
Blockly.Msg["ARROW_UP"] = "سهم لأعلى";
Blockly.Msg["ARROW_DOWN"] = "سهم لأسفل";
Blockly.Msg["ARROW_LEFT"] = "سهم لليسار";
Blockly.Msg["ARROW_RIGHT"] = "سهم لليمين";
Blockly.Msg["SPACE"] = "مسافة";
Blockly.Msg["RETURN"] = "إدخال";
Blockly.Msg["BKY_SENSOR_X"] = "X";
Blockly.Msg["BKY_SENSOR_X_TOOLTIP"] = "يعيد إحداثي X الحالي للطائرة المسيّرة";
Blockly.Msg["BKY_SENSOR_Z"] = "Z";
Blockly.Msg["BKY_SENSOR_Z_TOOLTIP"] = "يعيد إحداثي Z الحالي للطائرة المسيّرة";
Blockly.Msg["BKY_SENSOR_ALTITUDE"] = "الارتفاع";
Blockly.Msg["BKY_SENSOR_ALTITUDE_TOOLTIP"] = "يعيد الارتفاع الحالي للطائرة المسيّرة";
Blockly.Msg["BKY_SENSOR_DIRECTION"] = "الاتجاه";
Blockly.Msg["BKY_SENSOR_DIRECTION_TOOLTIP"] = "يعيد الاتجاه الحالي للطائرة المسيّرة";
Blockly.Msg["BKY_SENSOR_SPEED"] = "السرعة";
Blockly.Msg["BKY_SENSOR_SPEED_TOOLTIP"] = "يعيد إعداد السرعة الحالي";
Blockly.Msg["BKY_FLOW_START_TOOLTIP"] = "بداية البرنامج";
Blockly.Msg["BKY_FLOW_END_TOOLTIP"] = "نهاية البرنامج";
Blockly.Msg["BKY_FLOW_START"] = "بدء";
Blockly.Msg["BKY_FLOW_END"] = "نهاية";
Blockly.Msg["BKY_NEW"] = "جديد";
Blockly.Msg["BKY_LOAD"] = "تحميل";
Blockly.Msg["BKY_SAVE"] = "حفظ";
Blockly.Msg["BKY_HELP"] = "مساعدة";
Blockly.Msg["BKY_SCENARIO"] = "المشهد";
Blockly.Msg["BKY_FILE_NAME"] = "بدون اسم";
Blockly.Msg["BKY_SAVE_PROMPT"] = "اسم الملف:";
Blockly.Msg["BKY_GRAPHICS"] = "الرسومات";
Blockly.Msg["BKY_GRAPHICS_PERFORMANCE"] = "الأداء";
Blockly.Msg["BKY_GRAPHICS_BALANCED"] = "متوازن";
Blockly.Msg["BKY_GRAPHICS_QUALITY"] = "جودة عالية";
Blockly.Msg["BKY_STATUS_X"] = "X:";
Blockly.Msg["BKY_STATUS_Z"] = "Z:";
Blockly.Msg["BKY_STATUS_ALTITUDE"] = "الارتفاع:";
Blockly.Msg["BKY_STATUS_DIRECTION"] = "الاتجاه:";
Blockly.Msg["BKY_STATUS_FLIGHT"] = "الحالة:";
Blockly.Msg["BKY_STATUS_VARIABLES"] = "المتغيرات:";
Blockly.Msg["BKY_FLIGHT_IN_FLIGHT"] = "في الجو";
Blockly.Msg["BKY_FLIGHT_ON_GROUND"] = "على الأرض";
Blockly.Msg["BKY_CAMERA_PREVIEW"] = "معاينة الكاميرا";
Blockly.Msg["BKY_DARK_THEME"] = "المظهر الداكن";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY"] = "مجلد الصور/الفيديو:";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_SELECT"] = "اختيار...";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_RESET"] = "إعادة تعيين";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_DEFAULT"] = "تنزيلات المتصفح الافتراضية";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_UNSUPPORTED"] = "تنزيلات المتصفح الافتراضية (اختيار المجلد غير مدعوم)";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_PERMISSION_NEEDED"] = "الإذن مطلوب";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_PRIVACY"] = "لحماية الخصوصية، يعرض المتصفح اسم المجلد المحدد فقط.";
Blockly.Msg["BKY_CATEGORY_LOGIC"] = "المنطق";
Blockly.Msg["BKY_CATEGORY_LOOPS"] = "الحلقات";
Blockly.Msg["BKY_CATEGORY_MATH"] = "الرياضيات";
Blockly.Msg["BKY_CATEGORY_TEXT"] = "النص";
Blockly.Msg["BKY_CATEGORY_LISTS"] = "القوائم";
Blockly.Msg["BKY_CATEGORY_VARIABLES"] = "المتغيرات";
Blockly.Msg["BKY_CATEGORY_FUNCTIONS"] = "الدوال";
Blockly.Msg["BKY_CATEGORY_SENSORS"] = "المستشعرات";
Blockly.Msg["BKY_CATEGORY_DRONE"] = "الطائرة المسيّرة";
Blockly.Msg["BKY_CATEGORY_FLOW"] = "التدفق";
