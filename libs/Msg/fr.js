...
// French translation for Drone Commands
Blockly.Msg["BKY_DRONE_TAKEOFF"] = "décoller";
Blockly.Msg["BKY_DRONE_TAKEOFF_TOOLTIP"] = "Fait décoller le drone";
...
Blockly.Msg["BKY_DRONE_CHANGE_ALTITUDE"] = "modifier l'altitude %1";
Blockly.Msg["BKY_DRONE_CHANGE_ALTITUDE_TOOLTIP"] = "Modifie l'altitude du drone";

Blockly.Msg["BKY_DRONE_SET_ANGLE"] = "régler l'angle %1";
Blockly.Msg["BKY_DRONE_SET_ANGLE_TOOLTIP"] = "Règle l'angle du drone";

Blockly.Msg["BKY_DRONE_CHANGE_ANGLE"] = "modifier l'angle %1";
Blockly.Msg["BKY_DRONE_CHANGE_ANGLE_TOOLTIP"] = "Modifie l'angle du drone";

Blockly.Msg["BKY_DRONE_SLIDE"] = "glisser %1";
Blockly.Msg["BKY_DRONE_SLIDE_TOOLTIP"] = "Fait glisser le drone";

Blockly.Msg["BKY_DRONE_WALK"] = "avancer %1";
Blockly.Msg["BKY_DRONE_WALK_TOOLTIP"] = "Déplace le drone vers l'avant";

Blockly.Msg["BKY_DRONE_WALK_CLIMBING"] = "avancer en montant avancer %1 monter %2";
Blockly.Msg["BKY_DRONE_WALK_CLIMBING_TOOLTIP"] = "Déplace le drone vers l'avant en montant";
...
Blockly.Msg["BKY_DRONE_MOVE_BY_TOOLTIP"] = "Déplace selon la direction actuelle : X droite/gauche, Y haut/bas, Z avant/arrière";

Blockly.Msg["BKY_DRONE_CURVE_ABS"] = "courbe abs x %1 y %2 z %3 xd %4 yd %5 zd %6";
Blockly.Msg["BKY_DRONE_CURVE_ABS_TOOLTIP"] = "Fait voler le drone sur une courbe passant par la position actuelle, un point intermédiaire absolu et une destination absolue";

Blockly.Msg["BKY_DRONE_CURVE"] = "courbe x %1 y %2 z %3 xd %4 yd %5 zd %6";
Blockly.Msg["BKY_DRONE_CURVE_TOOLTIP"] = "Fait voler le drone sur une courbe avec des points relatifs à sa direction actuelle (Z avant/arrière, X droite/gauche)";
...
Blockly.Msg["ARROW_UP"]="Flèche Haut";
Blockly.Msg["ARROW_DOWN"]="Flèche Bas";
Blockly.Msg["ARROW_LEFT"]="Flèche Gauche";
Blockly.Msg["ARROW_RIGHT"]="Flèche Droite";
Blockly.Msg["SPACE"]="Espace";
Blockly.Msg["RETURN"]="Entrée";

Blockly.Msg["BKY_SENSOR_X"] = "X";
Blockly.Msg["BKY_SENSOR_X_TOOLTIP"] = "Renvoie la coordonnée X du drone";

Blockly.Msg["BKY_SENSOR_Z"] = "Z";
Blockly.Msg["BKY_SENSOR_Z_TOOLTIP"] = "Renvoie la coordonnée Z du drone";

Blockly.Msg["BKY_SENSOR_ALTITUDE"] = "Altitude";
Blockly.Msg["BKY_SENSOR_ALTITUDE_TOOLTIP"] = "Renvoie l'altitude du drone";

Blockly.Msg["BKY_SENSOR_DIRECTION"] = "Direction";
Blockly.Msg["BKY_SENSOR_DIRECTION_TOOLTIP"] = "Renvoie la direction du drone";

Blockly.Msg["BKY_SENSOR_SPEED"] = "vitesse";
Blockly.Msg["BKY_SENSOR_SPEED_TOOLTIP"] = "Renvoie la vitesse du drone";


// Flow
Blockly.Msg["BKY_FLOW_START_TOOLTIP"] = "démarrage du programme";
Blockly.Msg["BKY_FLOW_END_TOOLTIP"] = "arrêt du programme";

Blockly.Msg["BKY_FLOW_START"] = "Début";
...
Blockly.Msg.BKY_MEDIA_SAVE_DIRECTORY = "Dossier photo/vidéo :";
Blockly.Msg.BKY_MEDIA_SAVE_DIRECTORY_SELECT = "Choisir...";
Blockly.Msg.BKY_MEDIA_SAVE_DIRECTORY_RESET = "Réinitialiser";
Blockly.Msg.BKY_MEDIA_SAVE_DIRECTORY_DEFAULT = "Téléchargements par défaut du navigateur";
Blockly.Msg.BKY_MEDIA_SAVE_DIRECTORY_UNSUPPORTED = "Téléchargements par défaut (sélection de dossier non prise en charge)";
Blockly.Msg.BKY_MEDIA_SAVE_DIRECTORY_PERMISSION_NEEDED = "autorisation requise";
Blockly.Msg.BKY_MEDIA_SAVE_DIRECTORY_PRIVACY = "Pour protéger votre vie privée, le navigateur affiche uniquement le nom du dossier.";

// Category
Blockly.Msg["BKY_CATEGORY_LOGIC"]="Logique";
Blockly.Msg["BKY_CATEGORY_LOOPS"]="Boucles";
Blockly.Msg["BKY_CATEGORY_MATH"]="Mathématiques";
Blockly.Msg["BKY_CATEGORY_TEXT"]="Texte";
Blockly.Msg["BKY_CATEGORY_LISTS"]="Listes";
Blockly.Msg["BKY_CATEGORY_VARIABLES"]="Variables";
Blockly.Msg["BKY_CATEGORY_FUNCTIONS"]="Fonctions";
Blockly.Msg["BKY_CATEGORY_SENSORS"]="Capteurs";
