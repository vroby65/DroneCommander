...
Blockly.Msg["BKY_DRONE_TAKEOFF"] = "離陸";
Blockly.Msg["BKY_DRONE_TAKEOFF_TOOLTIP"] = "ドローンを離陸させます";
Blockly.Msg["BKY_DRONE_LAND"] = "着陸";
Blockly.Msg["BKY_DRONE_LAND_TOOLTIP"] = "ドローンを着陸させます";
Blockly.Msg["BKY_DRONE_TAKE_PHOTO"] = "写真を撮る";
Blockly.Msg["BKY_DRONE_TAKE_PHOTO_TOOLTIP"] = "ドローンカメラの PNG 画像をダウンロードします";
Blockly.Msg["BKY_DRONE_START_RECORDING"] = "録画を開始";
Blockly.Msg["BKY_DRONE_START_RECORDING_TOOLTIP"] = "ドローンカメラの動画撮影を開始します";
Blockly.Msg["BKY_DRONE_SAVE_RECORDING"] = "録画を保存";
Blockly.Msg["BKY_DRONE_SAVE_RECORDING_TOOLTIP"] = "録画を停止してドローンカメラの動画をダウンロードします";
Blockly.Msg["BKY_DRONE_SET_ALTITUDE"] = "高度を設定 %1";
Blockly.Msg["BKY_DRONE_SET_ALTITUDE_TOOLTIP"] = "ドローンの高度を設定します";
Blockly.Msg["BKY_DRONE_CHANGE_ALTITUDE"] = "高度を変更 %1";
Blockly.Msg["BKY_DRONE_CHANGE_ALTITUDE_TOOLTIP"] = "ドローンの高度を相対的に変更します";
Blockly.Msg["BKY_DRONE_SET_ANGLE"] = "角度を設定 %1";
Blockly.Msg["BKY_DRONE_SET_ANGLE_TOOLTIP"] = "ドローンの向きを設定します";
Blockly.Msg["BKY_DRONE_CHANGE_ANGLE"] = "角度を変更 %1";
Blockly.Msg["BKY_DRONE_CHANGE_ANGLE_TOOLTIP"] = "ドローンの向きを相対的に変更します";
Blockly.Msg["BKY_DRONE_SLIDE"] = "横移動 %1";
Blockly.Msg["BKY_DRONE_SLIDE_TOOLTIP"] = "ドローンを横方向に移動させます";
Blockly.Msg["BKY_DRONE_WALK"] = "前進 %1";
Blockly.Msg["BKY_DRONE_WALK_TOOLTIP"] = "ドローンを前進させます";
Blockly.Msg["BKY_DRONE_WALK_CLIMBING"] = "前進 %1 上昇 %2";
Blockly.Msg["BKY_DRONE_WALK_CLIMBING_TOOLTIP"] = "ドローンを前進させながら高度を変更します";
Blockly.Msg["BKY_DRONE_GO_TO"] = "移動先 x %1 y %2 z %3";
Blockly.Msg["BKY_DRONE_GO_TO_TOOLTIP"] = "現在の速度で絶対位置へ移動します";
Blockly.Msg["BKY_DRONE_MOVE_BY"] = "相対移動 x %1 y %2 z %3";
Blockly.Msg["BKY_DRONE_MOVE_BY_TOOLTIP"] = "現在の向きを基準に移動します：X は右/左、Y は上/下、Z は前/後";
Blockly.Msg["BKY_DRONE_CURVE_ABS"] = "絶対曲線 x %1 y %2 z %3 xd %4 yd %5 zd %6";
Blockly.Msg["BKY_DRONE_CURVE_ABS_TOOLTIP"] = "現在位置、絶対中間点、絶対目的地を通る曲線で飛行します";
Blockly.Msg["BKY_DRONE_CURVE"] = "相対曲線 x %1 y %2 z %3 xd %4 yd %5 zd %6";
Blockly.Msg["BKY_DRONE_CURVE_TOOLTIP"] = "ドローンの現在の向きを基準にした点を通る曲線で飛行します（Z は前/後、X は右/左）";
Blockly.Msg["BKY_DRONE_RETURN_TO_BASE"] = "基地に戻る";
Blockly.Msg["BKY_DRONE_RETURN_TO_BASE_TOOLTIP"] = "現在の速度で基地に戻ります";
Blockly.Msg["BKY_DRONE_WAIT"] = "待機 %1";
Blockly.Msg["BKY_DRONE_WAIT_TOOLTIP"] = "ドローンを待機させます";
Blockly.Msg["BKY_DRONE_SMOKE"] = "スモーク %1";
Blockly.Msg["BKY_DRONE_SMOKE_TOOLTIP"] = "ドローンのスモークをオンまたはオフにします";
Blockly.Msg["BKY_DRONE_SPEED"] = "速度 %1";
Blockly.Msg["BKY_DRONE_SPEED_TOOLTIP"] = "ドローンの速度を設定します（0～10）";
Blockly.Msg["BKY_SENSOR_KEYPRESSED"] = "キー %1 が押された";
Blockly.Msg["BKY_SENSOR_KEYPRESSED_TOOLTIP"] = "キーが押されている場合は真を返します";
Blockly.Msg["ARROW_UP"] = "上矢印";
Blockly.Msg["ARROW_DOWN"] = "下矢印";
Blockly.Msg["ARROW_LEFT"] = "左矢印";
Blockly.Msg["ARROW_RIGHT"] = "右矢印";
Blockly.Msg["SPACE"] = "スペース";
Blockly.Msg["RETURN"] = "Enter";
Blockly.Msg["BKY_SENSOR_X"] = "X";
Blockly.Msg["BKY_SENSOR_X_TOOLTIP"] = "ドローンの X 座標を返します";
Blockly.Msg["BKY_SENSOR_Z"] = "Z";
Blockly.Msg["BKY_SENSOR_Z_TOOLTIP"] = "ドローンの Z 座標を返します";
Blockly.Msg["BKY_SENSOR_ALTITUDE"] = "高度";
Blockly.Msg["BKY_SENSOR_ALTITUDE_TOOLTIP"] = "ドローンの現在の高度を返します";
Blockly.Msg["BKY_SENSOR_DIRECTION"] = "方向";
Blockly.Msg["BKY_SENSOR_DIRECTION_TOOLTIP"] = "ドローンの現在の向きを返します";
Blockly.Msg["BKY_SENSOR_SPEED"] = "速度";
Blockly.Msg["BKY_SENSOR_SPEED_TOOLTIP"] = "ドローンの現在の速度を返します";
Blockly.Msg["BKY_FLOW_START_TOOLTIP"] = "プログラム開始";
Blockly.Msg["BKY_FLOW_END_TOOLTIP"] = "プログラム終了";
Blockly.Msg["BKY_FLOW_START"] = "開始";
Blockly.Msg["BKY_FLOW_END"] = "終了";
Blockly.Msg["BKY_NEW"] = "新規";
Blockly.Msg["BKY_LOAD"] = "読み込む";
Blockly.Msg["BKY_SAVE"] = "保存";
Blockly.Msg["BKY_HELP"] = "ヘルプ";
Blockly.Msg["BKY_SCENARIO"] = "シナリオ";
Blockly.Msg["BKY_FILE_NAME"] = "無題";
Blockly.Msg["BKY_SAVE_PROMPT"] = "ファイル名：";
Blockly.Msg["BKY_GRAPHICS"] = "グラフィック";
Blockly.Msg["BKY_GRAPHICS_PERFORMANCE"] = "パフォーマンス";
Blockly.Msg["BKY_GRAPHICS_BALANCED"] = "バランス";
Blockly.Msg["BKY_GRAPHICS_QUALITY"] = "高品質";
Blockly.Msg["BKY_STATUS_X"] = "X：";
Blockly.Msg["BKY_STATUS_Z"] = "Z：";
Blockly.Msg["BKY_STATUS_ALTITUDE"] = "高度：";
Blockly.Msg["BKY_STATUS_DIRECTION"] = "方向：";
Blockly.Msg["BKY_STATUS_FLIGHT"] = "状態：";
Blockly.Msg["BKY_STATUS_VARIABLES"] = "変数：";
Blockly.Msg["BKY_FLIGHT_IN_FLIGHT"] = "飛行中";
Blockly.Msg["BKY_FLIGHT_ON_GROUND"] = "地上";
Blockly.Msg["BKY_CAMERA_PREVIEW"] = "カメラプレビュー";
Blockly.Msg["BKY_DARK_THEME"] = "ダークテーマ";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY"] = "写真・動画フォルダー：";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_SELECT"] = "選択...";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_RESET"] = "リセット";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_DEFAULT"] = "ブラウザーの既定のダウンロード先";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_UNSUPPORTED"] = "ブラウザーの既定のダウンロード先（フォルダー選択非対応）";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_PERMISSION_NEEDED"] = "アクセス許可が必要";
Blockly.Msg["BKY_MEDIA_SAVE_DIRECTORY_PRIVACY"] = "プライバシー保護のため、ブラウザーには選択したフォルダー名のみ表示されます。";
Blockly.Msg["BKY_CATEGORY_LOGIC"] = "論理";
Blockly.Msg["BKY_CATEGORY_LOOPS"] = "ループ";
Blockly.Msg["BKY_CATEGORY_MATH"] = "数学";
Blockly.Msg["BKY_CATEGORY_TEXT"] = "テキスト";
Blockly.Msg["BKY_CATEGORY_LISTS"] = "リスト";
Blockly.Msg["BKY_CATEGORY_VARIABLES"] = "変数";
Blockly.Msg["BKY_CATEGORY_FUNCTIONS"] = "関数";
Blockly.Msg["BKY_CATEGORY_SENSORS"] = "センサー";
Blockly.Msg["BKY_CATEGORY_DRONE"] = "ドローン";
Blockly.Msg["BKY_CATEGORY_FLOW"] = "フロー";
